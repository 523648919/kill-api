...
<div class="container" id="list">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading"><b style="font-size: 16px">员工未签到列表 <span class="badge">{{message}}</span></b>
            <div style="display: inline-block;text-align: right;width: 80%;">
                <input type="text" class="form-control" id="queryNmae" v-model="queryNmae" placeholder="查询员工姓名"
...
<script src="resource/vue/hj.js"></script>
</body>
</html>
